...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define ADC_BUFFER_SIZE 5000				// uint16
#define USB_BUFFER_SIZE ADC_BUFFER_SIZE*2 	// uint8
/* USER CODE END PD */
...
volatile int adc_conv_complete = 0;
/* USER CODE END PV */
...
int main(void)
{
  ...
  uint8_t transmit_buffer[USB_BUFFER_SIZE];
  while (1)
  {
    /* USER CODE END WHILE */
